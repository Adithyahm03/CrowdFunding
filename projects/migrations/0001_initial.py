    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason', models.CharField(choices=[('spam', 'Spam'), ('inappropriate', 'Inappropriate Content'), ('harassment', 'Harassment'), ('fraud', 'Fraud'), ('copyright', 'Copyright Violation'), ('offensive', 'Offensive Content'), ('hate_speech', 'Hate Speech'), ('false_information', 'False Information'), ('other', 'Other')], max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
